        ...
        <div id = "stop">
            ...
            <div class = "scoresheet">
                ...
                <table class = "set_comp" >
                    ...
                    <tr>
                        <td class = "setnum">set1</td><td><input class = "num_comp" type = "text"></input></td><td width = "8px;" text-align = "center;">:</td><td><input class = "num" type = "text"></input></td>
                    </tr>
                    <tr>
                        <td class = "setnum">set2</td><td><input class = "num_comp" type = "text"></input></td><td>:</td><td><input class = "num_comp" type = "text"></input></td>
                    </tr>
                    <tr>
                        <td class = "setnum">set3</td><td><input class = "num_comp" type = "text"></input></td><td>:</td><td><input class = "num_comp" type = "text"></input></td>
                    </tr>
                    <tr>
                        <td class = "setnum">set4</td><td><input class = "num_comp" type = "text"></input></td><td>:</td><td><input class = "num_comp" type = "text"></input></td>
                    </tr>
                    <tr>
                        <td class = "setnum">set5</td><td><input class = "num_comp" type = "text"></input></td><td>:</td><td><input class = "num_comp" type = "text"></input></td>
                    </tr>
                </table>
                <div class = "analysis">
                    <div class = "analysis_text"></div>
                </div>
            </div>
        </div>
    );
...
function icon3(){
    ...
    const comp = (    
        <div>
            ...
            <textarea class = "textboxes2"></textarea>
        </div>
    );
    count_id3++;
    ReactDOM.render(comp, document.getElementById(count_id++));
