...
const MoviesPage = () =>{
    const getMovies = () => {
        const movies = [
        {date: "2000-10-12", groupname: "BADMINTON LOVERS", betting: "10000", state: <><button className = "win">win</button> <button className = "lose">lose</button></> },
        {date: "2000-10-12", groupname: "BADMINTON LOVERS", betting: "1000", state: "win"},
